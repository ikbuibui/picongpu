...
#include "Frame.hpp"
#include "ParticleDescription.hpp"
...
namespace pmacc
{
    ...
    namespace sph
    {
         ...
         */
        template<typename T_ParticleDescription, typename T_DeviceHeap, unsigned DIM>
        ...
        public:
            ...
            using ParticleAttributeList
                = MakeSeq_t<typename T_ParticleDescription::ValueTypeSeq, localCellIdx, multiMask>;
            ...
            using FrameType = Frame<
                detail::OperatorCreatePairStaticArray<T_ParticleDescription::NumSlots::value>,
                FrameDescription>;
            ...
            // TODO make an box object for my frames and also enable corresponding function
            /* Type of the particle box which particle buffer create */
            // using ParticlesBoxType = ParticlesBox<FrameType, typename DeviceHeap::AllocatorHandle, SuperCellSize,
            // DIM>;
        ...
        public:
            ...
            // {
            //     return ParticlesBoxType(superCells->getDeviceBuffer().getDataBox(),
