...
namespace pmacc
{
    namespace sph
    {
        ...
        public:
            ...
            HDINLINE void derive(
                ...
                IdGenerator& idGen,
                pmacc::sph::Particle<T_OtherFrameType, T_OtherValueTypeSeq> const& srcParticle)
            {
            ...
            HDINLINE Particle& operator=(pmacc::sph::Particle<T_OtherFrameType, T_OtherValueTypeSeq> const& other)
            {
    ...
    namespace traits
    {
        ...
        struct HasIdentifier<pmacc::sph::Particle<T_FrameType, T_ValueTypeSeq>, T_Key>
        {
        private:
            using ParticleType = pmacc::sph::Particle<T_FrameType, T_ValueTypeSeq>;
        ...
        template<typename T_Key, typename T_FrameType, typename T_ValueTypeSeq>
        struct HasFlag<pmacc::sph::Particle<T_FrameType, T_ValueTypeSeq>, T_Key> : public HasFlag<T_FrameType, T_Key>
        {
        };

        template<typename T_Key, typename T_FrameType, typename T_ValueTypeSeq>
        struct GetFlagType<pmacc::sph::Particle<T_FrameType, T_ValueTypeSeq>, T_Key>
    ...
    namespace particles
    {
        namespace operations
        {
            namespace detail
            {
                ...
                struct Deselect<T_MPLSeqWithObjectsToRemove, pmacc::sph::Particle<T_FrameType, T_ValueTypeSeq>>
                {
                    using FrameType = T_FrameType;
                    using ValueTypeSeq = T_ValueTypeSeq;
                    using ParticleType = pmacc::sph::Particle<FrameType, ValueTypeSeq>;
                    ...
                    /* new particle type*/
                    using ResultType = pmacc::sph::Particle<FrameType, NewValueTypeSeq>;
