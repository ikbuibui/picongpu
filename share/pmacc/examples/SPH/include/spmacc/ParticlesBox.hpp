...
namespace pmacc
{
    ...
    namespace lockstep::traits
    {
        ...
        template<class T_Frame, typename T_DeviceHeapHandle, unsigned T_dim>
        struct MakeBlockCfg<sph::ParticlesBox<T_Frame, T_DeviceHeapHandle, T_dim>> : std::true_type
        {
            static constexpr uint32_t frameSize
                = sph::ParticlesBox<T_Frame, T_DeviceHeapHandle, T_dim>::FrameType::frameSize;
