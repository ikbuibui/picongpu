...
namespace pmacc
{
    ...
    namespace traits
    {
        ...
        struct HasIdentifier<pmacc::sph::Frame<T_CreatePairOperator, T_ParticleDescription>, T_IdentifierName>
        {
        private:
            using FrameType = pmacc::sph::Frame<T_CreatePairOperator, T_ParticleDescription>;
        ...
        template<typename T_IdentifierName, typename T_CreatePairOperator, typename T_ParticleDescription>
        struct HasFlag<pmacc::sph::Frame<T_CreatePairOperator, T_ParticleDescription>, T_IdentifierName>
        {
        private:
            using FrameType = pmacc::sph::Frame<T_CreatePairOperator, T_ParticleDescription>;
        ...
        template<typename T_IdentifierName, typename T_CreatePairOperator, typename T_ParticleDescription>
        struct GetFlagType<pmacc::sph::Frame<T_CreatePairOperator, T_ParticleDescription>, T_IdentifierName>
        {
        private:
            using FrameType = pmacc::sph::Frame<T_CreatePairOperator, T_ParticleDescription>;
            using FlagList = typename FrameType::FlagList;
