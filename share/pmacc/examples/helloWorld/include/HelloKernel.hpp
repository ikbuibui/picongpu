...
struct HelloKernel
{
        ...
        T_Mapping const& mapper) const
    {
        ...
        using BlockArea
            = pmacc::SuperCellDescription<SuperCellSize, pmacc::math::CT::Int<1, 1>, pmacc::math::CT::Int<1, 1>>;
        ...
        pmacc::lockstep::makeForEach<pmacc::math::CT::volume<SuperCellSize>::type::value>(worker)(
            [&](uint32_t const linearIdx)
            {
                ...
                printf(
                    "Hello World from rank %u, global position %d %d,  cellIdx %d %d, and block index %d %d \n",
                    globalRank,
                    globalPos[0],
                    globalPos[1],
                    cellIdx[0],
